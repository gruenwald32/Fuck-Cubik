...
public class ErrorMessage
{
	public ErrorMessage(String action, Exception e)
	{
		...
		int clickedButton = JOptionPane.showOptionDialog(Main.frame, message, "Error", JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE, null, new String[]{"Send error report", "Don't send error report"}, 0);
		if(clickedButton == 0)
		{
